  ...
  <section class="bg-white p-6 rounded shadow-md w-full max-w-sm">
    <form action="php/logueo.php" method="POST">
      ...
      <section class="mb-4 flex justify-center items-center gap-4">
        ...
        <input placeholder="usuario" type="text" id="usuario" name="usuario" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
      </section>
      <section class="mb-6 flex justify-center items-center gap-4">
        ...
        <input placeholder="contraseña" type="password" id="contraseña" name="contraseña" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
      </section>
      <footer>
