...
<head>
    ...
    <title>TP-05BongiovanniIvanAgustin</title>
...
<body class="container flex flex-col justify-between mx-auto bg-zinc-700  antialiased w-full h-full">
    <header class="text-center py-3 flex flex-col-reverse text-white gap-y-4 bg-zinc-900">
        <nav>
        ...
        <h1 class="text-4xl font-bold">Financiera</h1>
    </header>