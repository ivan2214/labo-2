...
<main class="flex justify-center h-full items-center">
    <section class="bg-white p-6 rounded shadow-md w-full max-w-sm flex flex-col items-center gap-4">
        ...
        <section class="w-full flex flex-col gap-4 items-center">
            <p class="block font-medium text-gray-700">El numero original es:</p>
            <span class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"><?= $numero ?></span>
        </section>
        <section class="w-full flex flex-col gap-4 items-center">
