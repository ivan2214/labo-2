  ...
  <section class="bg-white p-6 rounded shadow-md w-full max-w-sm">
    <form action="php/procesar.php" method="POST">
      <section class="flex justify-center items-center gap-4">
        ...
        <input type="number" min="1000" max="9999" id="numero" name="numero" required class="block px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
      </section>
